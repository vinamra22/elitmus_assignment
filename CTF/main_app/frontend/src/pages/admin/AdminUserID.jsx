      ...
      <div className='content'>
        <form className='updateForm' onSubmit={handleClick}>
            ...
            <div className='textCenter'>
              <h2 style={{marginBottom: "1rem"}}>Update the user</h2>
            </div>


          <div className="radioRow">
              <div className="inputWithLabel">
                <label className={"labelForInput " + (error && user.name.length <=0  ? 'labelForInputDanger' : 'null')}><i><FontAwesomeIcon icon={faUser}/></i> {error && !user.name ? "The user must have the name ":" Name "}</label>
                <input 
                  type="text"
              ...
              <div className="inputWithLabel">
                <label className={"labelForInput " + (error && user.email.length <=0  ? 'labelForInputDanger' : 'null')}><i><FontAwesomeIcon icon={faEnvelope}/></i> {error && !user.email ? "The user must have an email ":" email "}</label>
                <input 
                  type="email" 
