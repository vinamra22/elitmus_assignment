    ...
    <div>
      ...
      <div className='content'>
        ...
        <div className='textCenter'>
          <h2 style={{marginBottom: "1rem"}}>Add the user</h2>
        </div>


          <div className="radioRow">
              <div className="inputWithLabel">
                <label className={"labelForInput " + (error && user.name.length <=0  ? 'labelForInputDanger' : 'null')}><i><FontAwesomeIcon icon={faUser}/></i> {error && !user.name ? "The user must have a name" : "Less"}</label>
                <input 
                  type="text"
            ...
            <button className='buttonForm'>Add the user</button>
