  ...
  return (
    <div>
      ...
      <div className='textCenter'>
        <h2 style={{marginBottom: "2rem"}}>Add the level</h2>
      </div>
      ...
      <div className="radioRow">
        ...
        <div className="inputWithLabel">  
          <label className={"labelForInput " + (error && !level.title  ? 'labelForInputDanger' : 'null')}><i><FontAwesomeIcon icon={faAddressCard}/></i> {error && !level.title ? "Level must have the name ":" Name"} </label>
          <input 
            type="text"  
        ...
        <div className="inputWithLabel">  
          <label className={"labelForInput " + (error && level.points < 0  ? 'labelForInputDanger' : 'null')}><i><FontAwesomeIcon icon={faCoins}/></i> {error && level.points < 0 ? "Points must be positive ":" Points"}</label>
          <input 
            type="number"  
      ...
      <div className="radioRow">
        ...
        <div className="inputWithLabel">  
          <label className={"labelForInput " + (error && !level.hint  ? 'labelForInputDanger' : 'null')}><i><FontAwesomeIcon icon={faComments}/></i> {error && !level.hint  ? 'Level must have a ':' a tool'}</label>
          <textarea               
              type="text"  
        ...
        <button className='buttonForm'>Add the level</button>
