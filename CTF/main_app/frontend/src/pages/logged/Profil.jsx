                ...
                <form onSubmit={handleClick}>    
                    <div className="nameRow">
                        ...
                        <div className="inputWithLabelProfil">
                            <label className="labelForInput" >Less</label>
                            <input 
                        ...
                        <div className="inputWithLabelProfil">
                            <label className="labelForInput"> Repeat the password</label>
                            <input 
                                className="inputFieldProfil"
                                type="password"
                                autoComplete="off" 
                    ...
                    <h2 className='profilCenter'>Score: <i className='points'>{points}</i></h2>
                    
                    <div className="centerButton">
                        <button className='profilButton'>Update</button>
